...
chargerDepartements().then(() => {
  ...
  function launchQuizz(tab_index, depjson) {
    ...
    function verifierReponse() {
      ...
      if (levenshteinDistance(userInput, departement.ancienne_region.toLowerCase()) <= 2 || levenshteinDistance(userInput, departement.nouvelle_region.toLowerCase()) <= 2) {
        score++;
      }
  ...
  function afficherScore(score, tab_index) {
    ...
    let div = `<div id="resultat">
                  ...
                  <div id="endgame">
                    <button><a href="region.html">Rejouer</a></button>
